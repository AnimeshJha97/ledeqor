...
|---|---|---|---|---|
| P2 | Platform naming and repositioning | Pending | Being handled in parallel by user. Keep DocIntel as one course project only after final platform name is chosen. | Wait for naming decision from user |
