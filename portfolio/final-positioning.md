...
Senior Full Stack Engineer building production-grade applied AI applications.

## Resume Headline Options

Senior Full Stack Engineer | React, Node.js, Python, FastAPI, LLMs, RAG, AI Workflows

Senior Full Stack Engineer transitioning into Applied AI Engineering, with hands-on experience building document intelligence systems using LLMs, embeddings, vector search, RAG, and production-grade full-stack architecture.
