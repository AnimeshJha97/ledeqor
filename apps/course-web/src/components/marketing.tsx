...
export function PrimaryCta({
  ...
  return (
    <Link href={href} className="inline-flex items-center justify-center gap-2 rounded-md bg-brand px-4 py-2.5 text-sm font-semibold text-slate-950 shadow-sm transition hover:bg-cyan-300">
...
export function SecondaryCta({
  ...
  return (
    <Link href={href} className="inline-flex items-center justify-center gap-2 rounded-md border border-line bg-surface px-4 py-2.5 text-sm font-semibold text-slate-200 transition hover:border-brand hover:text-brand">
      {children}
    </Link>
  );
}
